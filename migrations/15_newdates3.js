...
async function performMigration(deployer, network, accounts) {
  ...
  const startDayOneTime = moment('2018-04-26 16:00:00+00:00').unix()
  const endDayOneTime = moment('2018-04-27 15:59:59+00:00').unix()
  const startTime = moment('2018-04-27 16:00:00+00:00').unix()
  const endTime = moment('2018-05-26 16:00:00+00:00').unix()
